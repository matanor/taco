...
methods
    ...
    function printOptimalParamTable...
        ...
        for algorithm_i=MultipleRunsResult.algorithmsResultOrder()
            ...
            if ~isempty(parameterRunResult)
                ...
                optimalParamValues = this.optimalToString(optimal, algorithm_i);
            else
                optimalParamValues = [];
            end
            optimalStr = [algorithmName this.SEPERATOR ...
                          optimalParamValues];
            disp(optimalStr);
        end
    end
    ...
    function R = optimalToString(this, optimal, algorithm_i)
        if algorithm_i == SingleRun.CSSLMC || ...
           algorithm_i == SingleRun.CSSLMCF
           R = [num2str(optimal.values.alpha) this.SEPERATOR ... 
                num2str(optimal.values.beta)  this.SEPERATOR ...
                num2str(optimal.values.labeledConfidence) this.SEPERATOR ... 
                num2str(optimal.values.K)     this.SEPERATOR ...
                this.EMPTY_CELL this.EMPTY_CELL this.EMPTY_CELL ...
                num2str(optimal.score) ];
        else
           R = [this.EMPTY_CELL this.EMPTY_CELL this.EMPTY_CELL ...
                num2str(optimal.values.K)   this.SEPERATOR ... 
                num2str(optimal.values.mu1) this.SEPERATOR ...
                num2str(optimal.values.mu2) this.SEPERATOR ... 
                num2str(optimal.values.mu3) this.SEPERATOR ...
                num2str(optimal.score) ];
        end
    end
