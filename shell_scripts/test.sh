...
qsub -N $runName -wd /u/matanorb/matlab/Experiments -q all.q -b y -o $outputFile -e $errorFile "matlab -nodesktop -r "\""runOnOdin('/u/matanorb/experiments/results/2012_02_06\')"\"" -logfile matlab.log"
